...
// Auto-expires when the calendar day rolls over — `readSavedPick` returns
// null if the saved date doesn't match today's ISO date, so the card
// naturally re-prompts on the next morning.
