...
function buildPrompt(req: ShopRequest): string {
  ...
  return [
    ...
    weatherLine,
    "",
    "DESTINATION & OCCASION FIT — match the local fashion sensibility and the vibe of the kind of place this is. A trip to Paris should feel Parisian (refined silhouettes, neutral palette, tailored linen). Tokyo should feel like considered Japanese minimalism. The Caribbean / Mediterranean coast should feel like resort wear (linen, coverups, sandals, flowy white). Iceland or Patagonia should feel like technical winter layers. An Indian wedding should feel festive and modest. A Marrakech medina visit should favor breathable, modest cuts in earthy tones. A Texas hill-country wedding should lean western-tinged. A Vegas weekend should lean toward going-out glam. Lean toward what stylish locals or savvy travelers actually wear there — not generic resort-wear stereotypes. For themed collections without a destination, lean on the OCCASION instead — formality, cultural / religious context, dress code, season. When the trip notes mention modesty, religious sites, or specific dress codes, surface that in the picks (e.g. shoulder coverage for a temple visit, head-coverable scarves for a mosque tour).",
    "",
    ...
    '  "specs": [',
    "    {",
    '      "searchQuery": string,    // 3-6 KEYWORDS, 20-40 chars total. "[color] [garment type] [optional fit/material]". E.g. "white linen blazer", "cropped denim jacket", "black ribbed tank". No adjectives like "comfortable" or "lightweight", no full sentences, no retailer names (those go in brandHint), no quotes, no boolean ops. The query is fed straight into Google — keep it the kind of thing you would actually type into a search bar.',
    ...
    "- searchQuery: 3-6 keywords MAX. Trim every adjective that isn't a color, fit, or material. Long verbose queries return zero hits on retailer indexes — short ones win.",
    "- Every spec must be coherent with the destination + occasion + climate. Don't suggest tweed for a beach trip, sequins for a hike, sundresses for Iceland in winter, or a strappy tank for a temple visit.",
