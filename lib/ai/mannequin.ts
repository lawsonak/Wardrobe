...
const HEAD_PROMPT = [
  ...
  "Image 2: a stylized fashion-illustration mannequin.",
  "Draw a friendly cartoon caricature portrait of the head in image 1. The result should read as a hand-drawn fashion-illustration / animated-feature character, NOT photoreal. Aim for the warmth of a Pixar or magazine-illustration portrait — clean linework, simplified shapes, soft painterly shading, slightly exaggerated friendly features (a touch larger eyes, expressive smile). Avoid photoreal skin texture, avoid an uncanny realistic stare.",
  "Match the color palette and painterly aesthetic of image 2's mannequin so the head fits visually on top of that body.",
  "Keep recognizable cues from image 1: hair color and rough hairstyle, glasses if present, skin tone, general face shape. Ignore the actual photo lighting and pose.",
  "Output requirements (CRITICAL):",
  "- Head ONLY, including hair, cropped just below the chin. No shoulders, no body, no neck below the jaw.",
  "- The head should be drawn front-facing, slightly smiling, eyes open and looking forward. Do NOT use the photo's exact angle or expression — restage it.",
