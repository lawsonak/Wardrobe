...
Run it a few times and pick the best output before committing — the
model is non-deterministic and you want a clean front-facing dress form
with no facial features and a plain background.
