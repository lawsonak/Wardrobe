...
// Default placement and size by slot (percent of canvas). Tuned for the
// SVG silhouette in MannequinSilhouette; the AI try-on path doesn't use
// these — it renders the dressed mannequin as a single image instead.
