...
// Picks a fresh outfit for today, persists it on disk, and returns
// the enriched items. Body { again?: boolean } nudges the AI when
// the user hits "Try another".
export async function POST(req: NextRequest) {
  ...
  // Build the prompt: weekday + (optional) weather context + try-again hint.
